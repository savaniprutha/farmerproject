      ...
      <div class="container-fluid">
        <div class="row">
           <div class="col-12 text-right p-3">
            <a href="viewnews.php" class="btn btn-primary btn-sm">View Seller</a>
          </div>
          <!-- left column -->
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                  ...
                  else
                  {
                    ...
                    move_uploaded_file($_FILES["txtsellerlogo"]["tmp_name"], "uploads/seller/".$filename1);
                  }
                  ...
                  else
                  {
                    ...
                    move_uploaded_file($_FILES["txtshopphoto"]["tmp_name"], "uploads/seller/".$filename2);
                  }
                  ...
                  else
                  {
                    ...
                    move_uploaded_file($_FILES["txtaadharcardphoto"]["tmp_name"], "uploads/seller/".$filename3);
                  }
                  ...
                  $result = mysqli_query($conn,"update tbl_seller set name='$sellername',shop_name='$shopname',contact_number='$contactnumber',email_id='$email_id',web_site='$web_site',about='$about',certificate_url='$filename004',logo='$filename1',shop_photo='$filename2',is_approve='$is_approve',user_name='$user_name',password='$password',address='$address',landmark='$landmark',pincode='$pincode',aadhar_card='$aadhar_card',aadhar_photo='$filename3'") or die(mysqli_error($conn));
              ...
              <form id="form1" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="txtsellername" name="txtsellername" class="form-control" id="txtsellername" value="<?php echo $row["name"] ?>">
                  </div>
                  <div class="form-group">
                    <label for="txtsellershopname">Shop Name</label>
                    <textarea class="form-control" name="txtsellershopname" id="txtsellershopname"><?php echo $row["shop_name"] ?></textarea>
                  </div>

                  <div class="form-group">
                    <label for="txtsellercontactnumber">Contact Number</label>
                    <textarea class="form-control" name="txtsellercontactnumber" id="txtsellercontactnumber"><?php echo $row["contact_number"] ?></textarea>
                  </div>
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="form-control" name="txtsellerabout" id="txtsellerabout"><?php echo $row["about"] ?></textarea>
                 </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="txtsellercertificateurl" id="txtaadharcardphoto" value="<?php echo $row["certificate_url"]; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="txtsellerlogo" id="txtsellerlogo" value="<?php echo $row["logo"]; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="txtshopphoto" id="txtshopphoto" value="<?php echo $row["shop_photo"]; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="txtselleraddress" id="txtselleraddress"><?php echo $row["address"] ?></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="txtsellerpincode" id="txtsellerpincode"><?php echo $row["pincode"] ?></textarea>
                  </div>

                  <div class="form-group">
                    <label for="txtselleraadharcard">Aadhar Card</label>
                    <textarea class="form-control" name="txtselleraadharcard" id="txtselleraadharcard"><?php echo $row["aadhar_card"] ?></textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" name="txtaadharcardphoto" id="txtaadharcardphoto" value="<?php echo $row["aadhar_photo"]; ?>">
                  ...
                  <div class="form-group">
                    <label for="txtsellerregistrationdatetime">Registration Date/Time</label>
                    <input type="text" name="txtsellerregistrationdatetime" class="form-control" id="txtsellerregistrationdatetime" >
                  </div>
