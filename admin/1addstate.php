      ...
      <div class="container-fluid">
        <div class="row">
           <div class="col-12 text-right p-3">
            <a href="viewstate.php" class="btn btn-primary btn-sm">View State</a>
          </div>
          <!-- left column -->
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                  ...
                  if( $title != "" ){
                   ...
                   $result = mysqli_query($conn,"insert into tbl_state (state_name) values ('$state_name')") or die(mysqli_error($conn));
              ...
              <form id="form1" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="txtcontacttitle" name="txtstatename" class="form-control" id="txtstatename" required>
                  </div>
