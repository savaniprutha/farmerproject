          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                  ...
                  if( $title != "" && $contact_no != "" && $contactpurpose = ""){
              ...
              <form id="form1" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="txtcontacttitle" type="text" pattern="[A-Za-z '-]{1,50}" required name="txtcontacttitle" class="form-control" id="txtcontacttitle" required>
                  </div>
                 

                  <div class="form-group">
                    <label for="txtcontactno">Contact No</label>
                    <textarea class="form-control" type="tel" pattern="[0-9]{10}" required Format: 0123456789 maxlength="10" name="txtcontactno" id="txtcontactno" required></textarea>
                  </div>

                   <div class="form-group">
                    <label for="txtcontactpurpose">Purpose</label>
                    <textarea class="form-control" type="text" pattern="[A-Za-z '-]{1,50}" required name="txtcontactpurpose" id="txtcontactpurpose" required></textarea>
                  </div>
