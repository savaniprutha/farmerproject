      ...
      <div class="container-fluid">
        <div class="row">
           <div class="col-12 text-right p-3">
            <a href="viewcategory.php" class="btn btn-primary btn-sm">View Category</a>
          </div>
          <!-- left column -->
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                  ...
                  $result = mysqli_query($conn,"insert into category (category_name,category_img) values ('$catname','$filename')") or die(mysqli_error($conn));
              ...
              <form id="form1" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" pattern="[A-Za-z '-]{1,50}" name="txtcatname" class="form-control" id="txtcatname" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" accept=".png,.jpg,.jpeg" required name="txtcatimg" class="custom-file-input" name="txtcatimg" id="txtcatimg">
