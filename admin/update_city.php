            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                ...
                $city_name= $_POST["txtcityname"];
                  ...
                  $result = mysqli_query($conn,"update tbl_city set state_id='$state_name',city_name='$city_name'") or die(mysqli_error($conn));
              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="txtstateid">State Id</label>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="txtcityname" id="txtcityname"></textarea>
                  </div>
