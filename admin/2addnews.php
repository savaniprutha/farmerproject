          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                  ...
                  if( $newstitle != "" && $newsdescription != "" && $img = ""){
              ...
              <form id="form1" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" pattern="[A-Za-z '-]{1,50}" required name="txtnewstitle" class="form-control" id="txtnewstitle" required>
                  </div>
                  <div class="form-group">
                    <label for="txtnewsdescription">Description</label>
                    <textarea class="form-control" pattern="[A-Za-z '-]{1,50}" required name="txtnewsdescription" id="txtnewsdescription" required></textarea>
                  </div>
                  <div class="form-group">
