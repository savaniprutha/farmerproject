...
<html lang="en-us">
    <head>
        ...
        <script>
            function meet(){
            valfname=document.mee.fname.value;
            if(valfname.length==0){
                alert("enter valid first name")
            }
            vallname=document.mee.lname.value;
            var alphl=/^[a-zA-Z]+$/
            if(vallname.match(alphl)){
    
            }
            else{
                alert("enter valid last name")
            }
            valph=document.mee.num.value;
            var alphn=/^[0-9]+$/
            if(valph.match(alphn)){
    
            }
 else{
                alert("enter valid number")
            }
            valph=document.mee.password.value;
            var alphn=/^[0-9][a-zA-Z]+$/
            if(valph.match(alphn)){
            ...
            vale=document.mee.email.value;
            var alphe=/^([a-zA-Z0-9_\.\-]+)@([a-zA-Z]+)\.([a-zA-Z]{2-5})$/
            if(vale.match(alphe)){
            ...
            valfname=document.mee.address.value;
            if(valfname.length==0){
...
<body>
        ...
        <form action=""  name="mee" method="post">
        <div class="container">
            <div class="row">
                <div class="col-10">
...
<label for="mobile">Mobile:</label>
                ...
                <div class="col-90">
                    <input type="tel" id="mobile" name="num" placeholder="only 10 digits are allowed">
                </div>
            </div>
            <div class="row">
                <div class="col-10">
...
<option value="MCA">MCA</option>
            ...
            <div class="row">
                <input type="submit" value="Registered" onclick="meet()">
            </div>  
        </div>  
    </form>
    </body>
