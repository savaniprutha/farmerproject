              ...
              <form id="form1" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div>
                    <img src="../user/assets/img/product/<?php echo $row["img1"]; ?>" height="10%" width="10%">
                  </div>
                  <!-- <div>
                    <img src="../user/assets/img/product/<?php echo $row["img2"]; ?>" height="10%" width="10%">
                  </div>
                  <div>
                    <img src="../user/assets/img/product/<?php echo $row["img3"]; ?>" height="10%" width="10%">
                  </div> -->
