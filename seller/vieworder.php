              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td> 
                      <a href="ordersdetails.php?id=<?php echo $row["orders_id"]; ?>" class="btn btn-dark btn-sm">View</a>
                      <a data-id="<?php echo $row["orders_id"]; ?>" data-toggle="modal" data-target="#modal-default" href="javascript:void(0);" class="btn btn-danger btn-sm btn-delete">Delete</a>
                    </td>
