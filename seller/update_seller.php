          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              if(isset($_POST["btnsubmit"]))
              {
                  ...
                  $certificate= $_POST["txtsellercertificateurl"];
                  ...
                  $result = mysqli_query($conn,"update tbl_seller set name='$sellername',shop_name='$shopname',contact_number='$contactnumber',email_id='$email_id',web_site='$web_site',about='$about',certificate_url='$certificate',logo='$filename1',shop_photo='$filename2',is_approve='$is_approve',user_name='$user_name',password='$password',address='$address',landmark='$landmark',pincode='$pincode',aadhar_card='$aadhar_card',aadhar_photo='$filename3',seller_id =' $seller_id'") or die(mysqli_error($conn));
              ...
              <form id="form1" method="post" enctype="multipart/form-data">
                <div class="card-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="txtsellercertificateurl">Certificate Url </label>
                    <textarea class="form-control" name="txtsellercertificateurl" id="txtsellercertificateurl"></textarea>
                 </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="txtsellerapprove" id="txtsellerapprove"></textarea>
                  </div>
